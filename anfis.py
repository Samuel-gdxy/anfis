...
class ANFIS:
    ...
    def __init__(self, X, Y, X_test, Y_test,memFunction):
        self.X = np.array(copy.copy(X))
        self.Y = np.array(copy.copy(Y))
        self.XLen = len(self.X)
        self.X_test = np.array(copy.copy(X_test))
        self.Y_test = np.array(copy.copy(Y_test))
    ...
    def plotResults(self):
        if self.trainingType == 'Not trained yet':
            ...
            plt.plot(range(len(self.Y_test)),self.Y_test,'b', label='original')
...
def forwardHalfPass(ANFISObj, Xs):
    ...
    # print("layer1:", layerOne)
    # print("layer2:", layerTwo)
    # print("layer3:", layerThree)
    # print("layer4:",layerFour)
    # print("wSum",wSum)
    # print("w", w)
